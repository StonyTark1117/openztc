...
public:
  UiLayout(IniReader * ini_reader, ResourceManager * resource_manager, CursorManager * cursor_manager);
  UiLayout(IniReader * ini_reader, ResourceManager * resource_manager, CursorManager * cursor_manager, std::string name);
  ~UiLayout();
